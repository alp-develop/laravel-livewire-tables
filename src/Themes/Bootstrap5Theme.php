...
final class Bootstrap5Theme implements ThemeContract
{
    ...
    public function classes(): array
    {
        return [
            ...
            'per-page-wrapper' => 'd-flex align-items-center gap-1',
            ...
            'bulk-checkbox-td' => '',
            'bulk-checkbox' => 'form-check-input mt-0 cursor-pointer lt-checkbox',
            ...
            'selection-actions' => 'd-flex flex-wrap align-items-center gap-2',
