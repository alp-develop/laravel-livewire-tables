...
final class Bootstrap4Theme implements ThemeContract
{
    ...
    public function classes(): array
    {
        return [
            ...
            'per-page-wrapper' => 'd-flex align-items-center lt-flex-gap-1 w-100',
            ...
            'bulk-dropdown-item' => 'lt-bulk-dropdown-item d-flex w-100 align-items-center px-3 py-2 small text-dark text-decoration-none bg-transparent border-0 text-left',
            ...
            'selection-select-page-btn' => 'btn btn-sm lt-btn-primary w-100',
            'selection-deselect-page-btn' => 'btn btn-sm btn-outline-secondary w-100',
            'selection-deselect-btn' => 'btn btn-sm btn-outline-danger w-100',
        ];
    }
}
