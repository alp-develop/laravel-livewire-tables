...
final class TailwindTheme implements ThemeContract
{
    ...
    public function classes(): array
    {
        return [
            ...
            'filter-dropdown' => 'absolute left-0 z-50 mt-2 rounded-lg bg-white shadow-lg ring-1 ring-gray-200 p-4',
            ...
            'per-page-wrapper' => 'flex items-center gap-1.5 w-full sm:w-auto',
            'per-page-label' => 'text-sm text-gray-500',
            'per-page-select' => 'lt-select w-full sm:w-auto rounded-lg border border-gray-300 bg-white py-2 pl-3 pr-3 text-sm',
            ...
            'selection-actions' => 'flex flex-col gap-2 w-full sm:flex-row sm:flex-wrap sm:items-center sm:w-auto',
            'selection-select-page-btn' => 'w-full sm:w-auto inline-flex items-center justify-center rounded-lg lt-bg-600 px-3 py-1.5 text-xs font-medium text-white lt-hover-bg-700 transition-colors cursor-pointer border-none',
            'selection-deselect-page-btn' => 'w-full sm:w-auto inline-flex items-center justify-center rounded-lg bg-white border border-gray-300 px-3 py-1.5 text-xs font-medium text-gray-600 hover:bg-gray-50 transition-colors cursor-pointer',
            'selection-deselect-btn' => 'w-full sm:w-auto inline-flex items-center justify-center rounded-lg bg-white border border-red-200 px-3 py-1.5 text-xs font-medium text-red-600 hover:bg-red-50 transition-colors cursor-pointer',
        ];
    }
}
